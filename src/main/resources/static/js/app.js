(() => {
    ...
    (() => {
        ...
        const script_form = document.querySelector(".order__form");
        ...
        script_form.addEventListener("submit", checkForm);
        ...
        function checkForm(e) {
            ...
            if (!(inputTo.classList.contains("error") || inputFrom.classList.contains("error"))) {
                let flag = false;
                for (let item of schedule) if (item.date === date.value && item.cityFrom === inputFrom.value && item.cityTo === inputTo.value) {
                    tickets.innerHTML = "";
                ...
                if (!flag) tickets.innerHTML = '<h2 class="not-found">Маршрут не знайдено</h2>';
            }
        }
