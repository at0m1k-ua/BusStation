(() => {
      ...
      !(function (e, t) {
        ...
        return (function (e) {
          ...
          function (e, t, n) {
            ...
            function b(e) {
              return (
                "[object Date]" === x(e) && "Invalid Date" !== e.toString()
              );
            }
            function g(e) {
                  ...
                  if ("click" === n) {
                    ...
                    var O = s.calendar.querySelector(".qs-submit"),
                      N = r.value
                        ...
                        .slice(0, 4);
                    (r.value = N),
                      O.classList[4 === N.length ? "remove" : "add"](
                        "qs-disabled"
                      );
                  }
              }
            ...
            function O(e, t) {
              ...
              return (
                o || t ? u(this, n) : o || u(this, new Date(a, r, 1)), this
              );
            }
            function N(e) {
              return I(this, e, !0);
            ...
            t.default = function (e, t) {
              ...
              return (
                u(n, n.startDate || n.dateSelected), n.alwaysShow && D(n), n
              );
            };
          },
        ]).default;
  ...
  (() => {
    ...
    function createNumberInput(inputClassName, opts) {
      ...
      if (-1 === navigator.userAgent.indexOf("MSIE 9.0"))
    ...
    var createDateFormatter = function (_a) {
      var _b = _a.config,
        ...
        _d = _a.isMobile,
        isMobile = void 0 === _d ? false : _d;
      return function (dateObj, frmt, overrideLocale) {
        var locale = overrideLocale || l10n;
        if (void 0 !== config.formatDate && !isMobile)
    ...
    function FlatpickrInstance(element, instanceConfig) {
      ...
      function getClosestActiveElement() {
        var _a;
        return (
          (null === (_a = self.calendarContainer) || void 0 === _a
            ? void 0
            : _a.getRootNode()
      ...
      function setCalendarWidth() {
        ...
        if (false === config.weekNumbers && 1 === config.showMonths) return;
        else if (true !== config.noCalendar)
          window.requestAnimationFrame(function () {
      ...
      function setHours(hours, minutes, seconds) {
        if (void 0 !== self.latestSelectedDateObj)
      ...
      function build() {
        ...
        if (self.config.inline || self.config.static) {
          ...
          if (self.config.inline)
            ...
            else if (void 0 !== self.config.appendTo)
            ...
            if ("range" === self.config.mode) {
              toggleClass(
                ...
                self.selectedDates[0] &&
                  0 === compareDates(date, self.selectedDates[0], true)
              );
              toggleClass(
                dayElement,
                "endRange",
                self.selectedDates[1] &&
                  0 === compareDates(date, self.selectedDates[1], true)
              );
              if ("nextMonthDay" === className)
      ...
      function focusOnDay(current, offset) {
        ...
        if (void 0 === startElem) self._input.focus();
      ...
      function buildDays() {
        ...
        if ("range" === self.config.mode && 1 === self.selectedDates.length)
          onMouseOver();
      }
      ...
      function changeMonth(value, isOffset) {
        ...
        if (
          (delta < 0 && true === self._hidePrevMonthArrow) ||
          (delta > 0 && true === self._hideNextMonthArrow)
        )
          return;
      ...
      function isEnabled(date, timeless) {
        ...
        if (
          ...
          return false;
        if (!self.config.enable && 0 === self.config.disable.length)
          return true;
        ...
        for (var i = 0, d = void 0; i < array.length; i++) {
          d = array[i];
          if ("function" === typeof d && d(dateToCheck)) return bool;
          else if (
            d instanceof Date &&
            void 0 !== dateToCheck &&
      ...
      function onMouseOver(elem, cellClass) {
        ...
        var hoverDate = elem
          ...
          initialDate = self
            .parseDate(self.selectedDates[0], void 0, true)
            .getTime(),
      ...
      function open(e, positionElement) {
        ...
        if (true === self.config.enableTime && true === self.config.noCalendar)
          if (
            false === self.config.allowInput &&
      ...
      function minMaxDateSetter(type) {
        return function (date) {
          ...
          if (self.selectedDates) {
            ...
            if (!self.selectedDates.length && "min" === type)
      ...
      function parseConfig() {
        ...
        for (i = 0; i < self.config.plugins.length; i++) {
          ...
          for (var key in pluginConf)
            ...
            else if ("undefined" === typeof userConfig[key])
      ...
      function setupLocale() {
        if (
          ...
          "undefined" === typeof flatpickr.l10ns[self.config.locale]
        )
      ...
      function selectDate(e) {
        ...
        if ("single" === self.config.mode) self.selectedDates = [selectedDate];
          ...
          if (0 !== compareDates(selectedDate, self.selectedDates[0], true))
        ...
        if (void 0 !== self.hourElement)
          void 0 !== self.hourElement && self.hourElement.focus();
      ...
      function set(option, value) {
        if (null !== option && "object" === typeof option) {
          ...
          for (var key in option)
            if (void 0 !== CALLBACKS[key])
              CALLBACKS[key].forEach(function (x) {
                return x();
              });
        } else {
          self.config[option] = value;
          if (void 0 !== CALLBACKS[option])
      ...
      function parseDateRules(arr) {
        return arr
          ...
          .map(function (rule) {
            ...
            else if (rule && "object" === typeof rule && rule.from && rule.to)
              return {
      ...
      function setupDates() {
        ...
        if (void 0 !== self.config.minTime)
          self.config.minTime = self.parseDate(self.config.minTime, "H:i");
        if (void 0 !== self.config.maxTime)
      ...
      function isDateSelected(date) {
        for (var i = 0; i < self.selectedDates.length; i++) {
          ...
          if (
            ...
            0 === compareDates(selectedDate, date)
          )
            return "" + i;
        }
        return false;
      ...
      function isDateInRange(date) {
        if ("range" !== self.config.mode || self.selectedDates.length < 2)
          return false;
        return (
      ...
      function updateValue(triggerChange) {
        ...
        if (void 0 !== self.mobileInput && self.mobileFormatStr)
    ...
    if ("undefined" !== typeof jQuery && "undefined" !== typeof jQuery.fn)
